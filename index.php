...
$allowFields = array('place_id', 'name', 'contact_phone', 'contact_formattedPhone', 'contact_twitter', 'location_address', 'location_crossStreet', 'location_lat', 'location_lng', 'location_distance', 'location_postalCode', 'location_cc', 'location_city', 'location_state', 'location_country', 'location_formattedAddress_0', 'location_formattedAddress_1', 'categories_0_id', 'categories_0_name', 'verified', 'stats_checkinsCount', 'stats_usersCount', 'stats_tipCount', 'url', 'specials_count', 'specials_items', 'hereNow_count', 'hereNow_summary', 'referralId');
